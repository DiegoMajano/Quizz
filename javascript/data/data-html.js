export const dataHtml = [
    ...
    },
    {
        ...
        opciones: ['method', 'action', 'type', 'enctype'],
        correcta: 'method'
    },
    {
    ...
    },
    {
        ...
        opciones: ['alt', 'title', 'desc', 'label'],
        correcta: 'alt'
    },
    {
        pregunta: '¿Cuál es la diferencia entre <div> y <span> en HTML?',
        opciones: ['Bloque / En línea', 'Texto / Multimedia', 'Tablas / Formularios', 'Son iguales'],
        correcta: 'Bloque / En línea'
    },
    {
        pregunta: '¿Qué atributo de la etiqueta <iframe> se usa para especificar el origen del contenido',
        opciones: ['src', 'href', 'source', 'link'],
        correcta: 'src'
    },
    {
